...
export const cartService = Object.freeze({
  async get() { return payload((await apiClient.get(userEndpoints.cart.get)).data); },
  ...
  async updateService(serviceId, quantity) { return (await apiClient.put(userEndpoints.cart.updateServiceQuantity, { AddOnServices: serviceId, quantity })).data; },
